...
public class InternationalFlightBooking {
    
    private static int id = 0;
    private static int flag = 0;

    public static void bookInternationalFlight(Scanner sc, Aircraft[] acft, Route[] flt, int totalRoutes, Ticket[] tck, Route[] intlFlights) {
       LocalDate dt = LocalDate.now();
        ...
        String section;
        String[] city = {"London", "NewYork", "India", "Singapore"};
        ...
        System.out.println("---------------------------------------------------------------------");
        System.out.println("For Flight Booking of : London-NewYork-India-Singapore");
    ...
    System.out.println("\n0.London\t\t1.NewYork\t\t2.India\t\t3.Singapore");
